  ...
  return {
    ...
    init() {
      ...
      this.$watch('maxDecibels', value => {
        ...
        if (this.spectrumAnalyzer != null)
          this.spectrumAnalyzer.setDecibels(val, this.minDecibels)
      })
      this.$watch('minDecibels', value => {
        ...
        if (this.spectrumAnalyzer != null)
          this.spectrumAnalyzer.setDecibels(this.maxDecibels, val)
      })
    ...
    onFileChange(files) {
      ...
      if (this.audioCtx == null) {
        ...
        this.spectrumAnalyzer.setDecibels(this.maxDecibels, this.minDecibels)
